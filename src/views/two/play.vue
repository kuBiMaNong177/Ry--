...
export default {
  ...
  created() {
    ...
    this.axios
      .get('http://localhost:3000/song/url?id=' + ( this.musicId2 ? this.musicId2: this.musicId))
      .then(res => {
        this.muiscList = res.data.data[0]
      }),
      this.axios
        .get('http://localhost:3000/song/detail?ids=' + ( this.musicId2 ? this.musicId2: this.musicId))
        .then(res => {
      ...
      this.axios
        .get('http://localhost:3000/lyric?id=' + ( this.musicId2 ? this.musicId2: this.musicId))
        .then(res => {
