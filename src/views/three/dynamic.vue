<template>
  <div class="naver">
    ...
    <div class="dong1">
      <div class="box">
        <img src="http://img3.imgtn.bdimg.com/it/u=4263012681,2831933206&fm=26&gp=0.jpg" />
      </div>
      <p>
        网易云音乐
        <span>转发：</span>
    ...
    <div class="dong2">
      <div class="box">
        <img src="http://img0.imgtn.bdimg.com/it/u=1339525308,2468653122&fm=11&gp=0.jpg" />
      </div>
      <p>
        网易云音乐
        <span>转发：</span>
...
export default {
  ...
  mounted() {
    this.axios
      .get('http://localhost:3000/user/event?uid=' + this.$cookies.get('id'))
      .then(res => {
