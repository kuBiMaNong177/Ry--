<template>
	<div class="naver">
		...
		<div class="dong1">
			<div class="box"><img src="http://img3.imgtn.bdimg.com/it/u=4263012681,2831933206&fm=26&gp=0.jpg"></div>
			<p>网易云音乐<span>转发：</span></p>
			<h6>13.23</h6>
			...
			<div class="box1">
				...
				<div class="box2">
					<img src="../../img/图片303.png">
					<h3>那些惊艳嗨翻天的华语现场...<br><span>by 雾与晨</span></h3>
				</div>
			</div>
			<ul>
				<li><img src="@/img/图标306.png">26</li>
				<li><img src="@/img/图标307.png">26</li>
				<li><img src="@/img/图标308.png">转发</li>
			</ul>
		</div>
		<div class="hots">
			<h2>热门话题&nbsp;&gt;</h2>
			<ul>
				<li><img src="@/img/图片309.png"></li>
				<li><img src="@/img/图片310.png"></li>
				<li><img src="@/img/图片311.png"></li>
			</ul>
		</div>
		<div class="dong2">
			<div class="box"><img src="http://img0.imgtn.bdimg.com/it/u=1339525308,2468653122&fm=11&gp=0.jpg"></div>
			<p>网易云音乐<span>转发：</span></p>
			<h6>13.23</h6>
			<span class="guanzhu">关注+</span>
			<h5>自然界中一些“隐形”的生物，这种有点透明的样子很神奇也很萌呀，可能这也是一种透明的保护色吧。</h5>
			<div class="box1">
				<ul>
					<li><img src="@/img/图片312.png"></li>
					<li><img src="@/img/图片312.png"></li>
					<li><img src="@/img/图片312.png"></li>
					<li><img src="@/img/图片312.png"></li>
				</ul>
 ...
 */
	...
	.dong1 {
		...
		min-height: 20rem;
		position: relative;
		border-bottom: 0.3125rem rgba(217, 217, 217, 1) solid;
	}
	...
	.dong2 {
		...
		min-height: 20rem;
		position: relative;
		border-bottom: white solid 3.125rem;
	}
