...
export default {
  ...
  mounted() {
    this.axios.get('http://localhost:3000/dj/toplist/popular?limit=99')
    .then(res=>{
      console.log(res.data.data.list)
      this.list=res.data.data.list
    })
    // 24小时榜
    this.axios.get('http://localhost:3000/dj/program/toplist/hours?limit=3')
    .then(res=>{
      console.log(res.data.data.list)
      this.lists=res.data.data.list
    })
    // 新人榜
    this.axios.get('http://localhost:3000/dj/toplist/newcomer?limit=3')
    .then(res=>{
      console.log(res.data.data.list)
